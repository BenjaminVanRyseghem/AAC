...
Pour cela nous utilisons la fonction $f$ précédemment défini appliquée à l'intervalle $\ldbrack a,b\rdbrack$ afin de trouver la valeur où l'erreur est minimale.
Cette valeur est ce que nous avons appelé $x_{\ldbrack a,b\rdbrack}$.\\
