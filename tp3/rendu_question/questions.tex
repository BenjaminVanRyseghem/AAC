...
De plus, nous savons calculer sa longueur à partir de la longueur de la solution de $P'$.

\paragraph{Implémentation}
La méthode a une complexité de $O(n^2)$ en $n$ le nombre de villes.
...
\paragraph{Introduction de la borne inférieure}
...
De même, du fait du bannissement de tous les arcs de de la forme $(*,j)$, on peut alors retirer $min_e(v_j)$ de la borne $d$.
